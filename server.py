...
def initialize_db():
    ...
    cur.execute("""INSERT INTO products (name, imgpath, price, stock) VALUES \
        ('Spinach Seeds', 'images/spinachseed.jpg', 298, 34), \
        ('Lavender Seeds', 'images/lavanderseed.jpg', 566, 300), \
        ('Okra Seeds', 'images/okraseed.jpg', 479, 123), \
        ('Tomato Seeds', 'images/tomatoseed.jpg', 389, 100)
    """)
